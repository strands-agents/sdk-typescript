 ...
 * execution results, file metadata, streaming chunks, and snapshots.
 */
 ...
 *
 * The contents are opaque and backend-specific — consumers should not
 * inspect or modify the `data` field. Pass the snapshot back to the
 * same backend's constructor to resume.
 */
